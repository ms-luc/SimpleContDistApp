...
public class LocalDNS extends DNS{
  ...
  static DNSRecord hisDNS = new DNSRecord("dns.hiscinema.com", new InetSocketAddress("localhost",40201), "A");
  static DNSRecord herDNS = new DNSRecord("dns.herCDN.com", new InetSocketAddress("localhost",40202), "A");
